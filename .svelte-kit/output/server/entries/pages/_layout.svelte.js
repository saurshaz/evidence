...
const Dropdown_menu_content = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Menu_content, "DropdownMenuPrimitive.Content").$$render(
    ...
    Object.assign(
      ...
      { sideOffset },
      {
        class: cn("z-50 min-w-[8rem] rounded-md border bg-popover p-1 shadow-md bg-white focus:outline-none antialiased text-gray-800 print:hidden", className)
      },
      $$restProps
    ),
    {},
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header class="${"fixed w-full top-0 z-40 flex h-12 shrink-0 justify-start items-center gap-x-4 border-b border-gray-200 bg-white/90 backdrop-blur print:hidden " + escape(sidebarFrontMatter === "hide" ? "md:pl-8" : "", true)}"><div${add_attribute(
    "class",
    (fullWidth ? "max-w-full " : maxWidth ? "" : " max-w-7xl ") + "mx-auto px-6 sm:px-8 md:px-12 flex flex-1 items-center justify-between",
    0
  )} style="${"max-width:" + escape(maxWidth, true) + "px;"}">${hideSidebar || sidebarFrontMatter === "never" ? `<a href="/" class="block text-sm font-bold text-gray-800">${validate_component(Logo, "Logo").$$render($$result, { logo, title }, {}, {})}</a>` : `<div class="flex gap-x-4 items-center"><button type="button" class="${"text-gray-900 hover:bg-gray-50 rounded-lg p-1 transition-all duration-500 " + escape(sidebarFrontMatter === "hide" ? "block" : "md:hidden", true)}">${mobileSidebarOpen ? `<span class="sr-only" data-svelte-h="svelte-13q18xv">Close sidebar</span> ${validate_component(Icon, "Icon").$$render($$result, { class: "w-5 h-5", src: X }, {}, {})}` : `<span class="sr-only" data-svelte-h="svelte-73kebv">Open sidebar</span> ${validate_component(Icon, "Icon").$$render($$result, { class: "w-5 h-5", src: Menu2 }, {}, {})}`}</button> <a href="/" class="text-sm font-bold text-gray-800 hidden md:block">${validate_component(Logo, "Logo").$$render($$result, { logo, title }, {}, {})}</a></div>`} <div class="flex gap-2 text-sm items-center">${algolia ? `${validate_component(AlgoliaDocSearch, "AlgoliaDocSearch").$$render($$result, { algolia }, {}, {})}` : ``} <div class="flex gap-2 items-center">${githubRepo ? `<a${add_attribute("href", githubRepo, 0)} class="hover:bg-gray-50 rounded-lg p-2 transition-all duration-200" target="_blank" rel="noreferrer">${validate_component(Icon, "Icon").$$render(
    $$result,
    {
      src: Github,
...
const Sidebar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${mobileSidebarOpen ? `<div class="fixed inset-0 bg-white/80 z-50 backdrop-blur-sm" role="button" tabindex="-1"></div> <div class="bg-white border-r border-gray-300 shadow-lg fixed inset-0 z-50 flex sm:w-72 h-screen w-screen flex-col overflow-hidden select-none"><div class="pb-4 text-gray-700"><div class="py-3 px-8 mb-3 flex items-start justify-between"><a href="/" class="block mt-1 text-sm font-bold text-gray-800">${validate_component(Logo, "Logo").$$render($$result, { logo, title }, {}, {})}</a> <span role="button" tabindex="-1"><button type="button" class="text-gray-900 hover:bg-gray-50 rounded-lg p-1 transition-all duration-500" data-svelte-h="svelte-f2w8lm"><span class="sr-only">Close sidebar</span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5"><path d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z"></path></svg></button></span></div> <div class="flex-grow px-8 sm:pb-0 pb-4 h-[calc(100vh-8rem)] overflow-auto text-base sm:text-sm pretty-scrollbar" id="mobileScrollable"><div class="flex flex-col pb-6"><a class="sticky top-0 bg-white shadow shadow-white text-gray-950 font-semibold pb-1 mb-1 group inline-block capitalize transition-colors duration-100" href="/" data-svelte-h="svelte-zadvlr">Home</a> ${each(firstLevelFiles, (file) => {
    ...
    return `${file.children.length > 0 ? `<div class="flex flex-col pb-6">${file.href && (file.frontMatter?.sidebar_link !== false || file.frontMatter?.sidebar_link === void 0) ? `<a class="sticky top-0 bg-white shadow shadow-white text-gray-950 font-semibold pb-1 mb-1 group inline-block capitalize transition-colors duration-100"${add_attribute("href", file.href, 0)}>${escape(file.frontMatter?.title ?? file.label)} ${file.frontMatter?.sidebar_badge ? `${validate_component(Badge, "Badge").$$render($$result, {}, {}, {
      default: () => {
        return `${escape(file.frontMatter.sidebar_badge)} `;
      }
    })}` : ``} </a>` : `<span class="sticky top-0 bg-white shadow shadow-white text-gray-950 font-semibold pb-1 mb-1 group inline-block capitalize transition-colors duration-100"${add_attribute("href", file.href, 0)}>${escape(file.frontMatter?.title ?? file.label)} ${file.frontMatter?.sidebar_badge ? `${validate_component(Badge, "Badge").$$render($$result, {}, {}, {
      default: () => {
        return `${escape(file.frontMatter.sidebar_badge)} `;
      }
    ...
    hideHeader ? "top-8" : ""
  ].join(" ").trim()}"><div class="flex flex-col pb-6"><a class="sticky top-0 bg-white shadow shadow-white text-gray-950 font-semibold pb-1 mb-1 group inline-block capitalize hover:underline" href="/" data-svelte-h="svelte-p1gyq8">Home</a> ${each(firstLevelFiles, (file) => {
    return `${file.children.length === 0 && file.href && (file.frontMatter?.sidebar_link !== false || file.frontMatter?.sidebar_link === void 0) ? (() => {
      let active = $page.url.pathname.toUpperCase() === file.href.toUpperCase() + "/";
      return ` <a class="${[
    ...
    })}` : ``} </a>` : `<span class="sticky top-0 bg-white shadow shadow-white text-gray-950 font-semibold pb-1 mb-1 group inline-block capitalize"${add_attribute("href", file.href, 0)}>${escape(file.frontMatter?.title ?? file.label)} ${file.frontMatter?.sidebar_badge ? `${validate_component(Badge, "Badge").$$render($$result, {}, {}, {
      default: () => {
        return `${escape(file.frontMatter.sidebar_badge)} `;
      }
    })}` : ``} </span>`} ${each(file.children, (file2) => {
...
const ContentsList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${headers && headers.length > 1 ? `<span class="block text-xs sticky top-0 mb-2 text-gray-950 bg-white shadow-white font-medium" data-svelte-h="svelte-pfe38l">On this page</span> ${each(headers, (header) => {
